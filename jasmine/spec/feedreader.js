...
$(function() {
    ...
    */
    ...
    describe('The menu', function() {
        ...
        var hamburgerIcon = document.querySelector(".menu-icon-link");
    ...
    describe('Initial Entries', function() {
        ...
        it('contain at least a single element', function(){
    ...
    describe('New Feed Selection', function() {
        ...
        var postloadContent;      
        beforeEach(function(done){
            preloadContent = document.querySelector(".feed").innerHTML;

            loadFeed(0, function(){
                done();
                postloadContent = document.querySelector(".feed").innerHTML;
            });
            
        });

        it('loads new content', function(){
            expect(preloadContent).not.toBe(postloadContent);
